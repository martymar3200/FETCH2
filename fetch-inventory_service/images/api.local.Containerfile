...
# Use mounted certificates from host (generated by mkcert for trusted local HTTPS)
CMD ["uvicorn", "app.main:app", "--host", "0.0.0.0", "--port", "8001", "--ssl-keyfile", "/code/certs/localhost+2-key.pem", "--ssl-certfile", "/code/certs/localhost+2.pem"]
