# /code/app/models/non_tray_item_retrieval_events.py - REFACRORED TO SQLALCHEMY V2
...
class NonTrayItemRetrievalEvent(Base): # <--- Inherit from Base
    """
    ...
    non_tray_item_id: Mapped[int] = mapped_column(ForeignKey("non_tray_items.id"), nullable=False)
